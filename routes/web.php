...
Route::match(['get', 'post'], '/admin/add-page', 'PageController@addPage')->name('page.add');
Route::get('admin/pages','PageController@index');
Route::delete('admin/pages/{page}', 'PageController@destroy')->name('page.destroy');
Route::get('admin/pages/{page}/edit', 'PageController@edit')->name('page.edit');
Route::post('admin/pages/{page}/update', 'PageController@update')->name('page.update');
Route::get('admin/pages/{page}/show', 'PageController@show')->name('page.show');
